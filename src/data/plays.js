const plays = [
  {
    ...
    motions: [
      { player: "TE_L", path: [{ x: 30, y: 52 }, { x: 36, y: 55 }], type: "pre-snap" },
      { player: "TE_R", path: [{ x: 70, y: 52 }, { x: 64, y: 55 }], type: "pre-snap" },
      { player: "SB", path: [{ x: 22, y: 58 }, { x: 38, y: 52 }], type: "motion" },
    ],
    ballCarrier: "RB",
  ...
  },
  {
    ...
    motions: [
      { player: "TE_L", path: [{ x: 30, y: 52 }, { x: 36, y: 55 }], type: "pre-snap" },
      { player: "TE_R", path: [{ x: 70, y: 52 }, { x: 64, y: 55 }], type: "pre-snap" },
      { player: "RB",   path: [{ x: 50, y: 75 }, { x: 68, y: 55 }], type: "pre-snap" },
      { player: "SB", path: [{ x: 22, y: 58 }, { x: 32, y: 42 }], type: "motion" },
    ],
    ballCarrier: "SB",
  ...
  },
  {
    ...
    motions: [
      { player: "TE_L", path: [{ x: 30, y: 52 }, { x: 36, y: 55 }], type: "pre-snap" },
      { player: "TE_R", path: [{ x: 70, y: 52 }, { x: 64, y: 55 }], type: "pre-snap" },
      { player: "SB", path: [{ x: 22, y: 58 }, { x: 72, y: 58 }], type: "motion" },
    ],
    routes: [
